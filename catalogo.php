    ...
    <div class="row mb-5">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            ...
            <div class="card collection-card z-depth-1-half">
                <!--Card image-->
                <div class="view zoom">
                    <img src="img/bracelet-1198740_640.jpg" class="img-fluid" alt="">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            ...
            <div class="card collection-card z-depth-1-half">
                <!--Card image-->
                <div class="view zoom">
                    <img src="img/wristwatch-407096_640.jpg" class="img-fluid" alt="">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            ...
            <div class="card collection-card z-depth-1-half">
                <!--Card image-->
                <div class="view zoom">
                    <img src="img/jewellery-2043_640.jpg" class="img-fluid" alt="">
                    <div class="stripe dark">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            ...
            <div class="card collection-card z-depth-1-half">
                <!--Card image-->
                <div class="view zoom">
                    <img src="img/wedding-rings-3611277_640.jpg" class="img-fluid" alt="">
                    <div class="stripe light">
                        <a href="Anillos.html">
                            <p>Anillos
                                <i class="fas fa-angle-right"></i>
        ...
        <div class="col-lg-3 col-md-6">
            ...
            <div class="card collection-card z-depth-1-half">
                <!--Card image-->
                <div class="view zoom">
                    <img src="img/jewellery-791073_640.jpg" class="img-fluid" alt="">
                    <div class="stripe dark">
        ...
        <div class="col-lg-3 col-md-6ñ">
            ...
            <div class="card collection-card z-depth-1-half">
                <!--Card image-->
                <div class="view zoom">
                    <img src="img/heart-ring-584977_640.jpg" class="img-fluid" alt="">
                    <div class="stripe light">
                        <a href="niños.html">
                            <p>Niños.
                                <i class="fas fa-angle-right"></i>
