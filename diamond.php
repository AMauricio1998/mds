    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
<<<<<<< HEAD
                    <a class="nav-link" href="producto.php">Ofertas</a>
=======
                    <a class="nav-link" href="pulseras.php">Ofertas</a>
>>>>>>> 390ba1433bc70dbc7b9fcb8763f355a706cbe3a4
                </li>
                <li class="nav-item dropdown">
                    ...
                    <a class="dropdown-item" href="perfil.html"> <i class="fa fa-user-circle"> </i>  Perfil</a>
                        <a class="dropdown-item" href="compra.php"><i class="fa fa-shopping-cart"> </i> Compras </a>
...
<<<<<<< HEAD
                        ...
                        <a class="dropdown-item" href="sistema.php"><i class="fa fa-images"> </i> Sistema </a>
=======
>>>>>>> 390ba1433bc70dbc7b9fcb8763f355a706cbe3a4
                </li>
                <li class="nav-item">
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img src="img/banner22.png" class="d-block w-100" alt="...">
            <div class="carousel-caption d-none d-md-block">
            </div>
          </div>
          <div class="carousel-item">
...
<div class="row">
  ...
  <div class="col-lg-4 col-md-12">
    ...
    <div class="card card-cascade">
      ...
      <div class="view view-cascade overlay">
        <img src="img/jewelry-618429_640.jpg" class="card-img-top"
          alt="wider">
        <a href="#!">
  ...
  <div class="col-lg-4 col-md-6">
    <div class="card card-cascade">
      ...
      <div class="view view-cascade overlay">
        <img src="img/hands-1031131_640.jpg" class="card-img-top"
          alt="narrower">
        <a>
          <div class="mask rgba-white-slight"></div>
        </a>
  ...
  <div class="col-lg-4 col-md-6">
    ...
    <div class="card card-cascade">
      ...
      <!--Card image-->
      <div class="view view-cascade overlay">
        <img src="img/girl-2366438_640.jpg" class="card-img-top" alt="normal">
        <a>
          <div class="mask rgba-white-slight"></div>
        </a>
      </div>
...
<a href="https://www.facebook.com/SamHiterx" type="button" class="btn btn-fb"><i class="fab fa-facebook-f"></i></a> <button href="https://www.instagram.com/?hl=es-la"type="button" class="btn btn-ins"><i class="fab fa-instagram"></i></button>
